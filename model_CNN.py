...
path1 = r"C:/python code/insect detection/Training/10"    #path of folder of images    
path2 = r"C:/python code/insect detection/Train/10"  #path of folder to save images    
